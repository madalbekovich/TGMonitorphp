    ...
    public function onUpdateNewMessage(array $update): void
    {
        ...
        try {
            ...
            if (isset($message['grouped_id'])) {
                ...
                $this->logger("Получение истории сообщений для группы: " . $message['grouped_id']);
                ...
                if (isset($history['messages']) && !empty($history['messages'])) {
                    ...
                    foreach ($history['messages'] as $historyMessage) {
                        if (isset($historyMessage['grouped_id']) && 
                            $historyMessage['grouped_id'] === $message['grouped_id'] &&
                            isset($historyMessage['id'])) {
